-module(roadrunner_ws_hibernate_handler).
-moduledoc """
Test fixture — `roadrunner_ws_handler` that returns the 4-tuple opts
...
-spec handle_frame(roadrunner_ws:frame(), term()) ->
    {reply, [{roadrunner_ws:opcode(), iodata()}], term(), [roadrunner_ws_handler:opt()]}
    | {ok, term(), [roadrunner_ws_handler:opt()]}
    | {close, term()}.
